                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="flex flex-col items-center">
                                <ClockCircleOutlined className="text-xl text-blue-500 mb-2" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                            ...
                            {/* Mức độ hoàn thành */}
                            <div className="flex flex-col items-center">
                                <StarOutlined className="text-xl text-yellow-500 mb-2" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                            ...
                            {/* Tổng điểm */}
                            <div className="flex flex-col items-center">
                                <TrophyOutlined className="text-xl text-green-500 mb-2" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
